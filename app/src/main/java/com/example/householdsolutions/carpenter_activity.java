...
public class carpenter_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carpenter_activity);
        Spinner spinner=(Spinner) findViewById(R.id.spinner);
        ArrayAdapter<String> myadapter=new ArrayAdapter<>(carpenter_activity.this, android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.districts));
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spinner.isSelected()) {
                    Toast.makeText(carpenter_activity.this, "Please Select District!", Toast.LENGTH_SHORT).show();
                }else if (address.isEmpty()) {
                    Toast.makeText(carpenter_activity.this, "Enter Your Address!", Toast.LENGTH_SHORT).show();
                }else if (rd1.isChecked() || rd2.isChecked()){
                    ArrayList<String> list= new ArrayList<String>();
                    ArrayAdapter adapter= new ArrayAdapter(carpenter_activity.this,android.R.layout.simple_list_item_1,list);
                    listView.setAdapter(adapter);

                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Employees");
                    DatabaseReference reference1=reference.child(district).child("Carpenter");
                    reference1.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(carpenter_activity.this, "Service is not available in your area", Toast.LENGTH_SHORT).show();
                        }
                    });
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent intent= new Intent(carpenter_activity.this,details_preview.class);
                            ...
                            intent.putExtra(details_preview.Occupation,"Carpenter");
                            startActivity(intent);
                        }
                    });
                }else {
                    Toast.makeText(carpenter_activity.this, "Please Select Payment Method", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
