...
public class electricity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myadapter=new ArrayAdapter<>(electricity.this, android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.districts));
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spinner.isSelected()) {
                    Toast.makeText(electricity.this, "Please Select District!", Toast.LENGTH_SHORT).show();
                }else if (address.isEmpty()) {
                    Toast.makeText(electricity.this, "Enter Your Address!", Toast.LENGTH_SHORT).show();
                }else if (rd1.isChecked() || rd2.isChecked()){
                    ArrayList<String> list= new ArrayList<String>();
                    ArrayAdapter adapter= new ArrayAdapter(electricity.this,android.R.layout.simple_list_item_1,list);
                    listView.setAdapter(adapter);

                    DatabaseReference reference =FirebaseDatabase.getInstance().getReference("Employees");
                    DatabaseReference reference1=reference.child(district).child("Electrician");
                    reference1.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(electricity.this, "Service is not available in your area", Toast.LENGTH_SHORT).show();
                        }
                    });
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent intent= new Intent(electricity.this,details_preview.class);
                            ...
                            intent.putExtra(details_preview.Occupation,"Electrician");
                            startActivity(intent);
                        }
                    });
                }else {
                    Toast.makeText(electricity.this, "Please Select Payment Method", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
